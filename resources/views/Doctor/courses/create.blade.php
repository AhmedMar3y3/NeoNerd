...
<div class="course-form-container" dir="rtl">
    ...
    <div class="page-header">
        <h1 class="page-title">إنشاء دورة جديدة</h1>
        <p class="page-subtitle">أضف دورة تعليمية جديدة إلى منصتك</p>
    </div>

    <div class="form-card">
        <form action="{{ route('doctor.courses.store') }}" method="POST" enctype="multipart/form-data" id="courseForm">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea class="form-textarea @error('description') is-invalid @enderror" 
                              name="description" 
                              placeholder="أدخل وصف مفصل للدورة...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i>
                            {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload">
                        ...
                        <label for="courseImage" class="file-upload-label">
                            ...
                            <span>اختر صورة للدورة أو اسحبها هنا</span>
                        </label>
                    </div>
                    @error('image')
                        <div class="error-message">
