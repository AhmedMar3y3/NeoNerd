...
@section('main')
    <div class="row" dir="rtl">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        ...
                        <form action="{{ route('store.toggleOpenClose') }}" method="POST" class="mt-3">
                            ...
                            <button type="submit"
                                class="btn btn-toggle-open-close {{ $isOpen ? 'btn-danger' : 'btn-success' }} w-100 d-flex align-items-center justify-content-center gap-2">
        ...
        <div class="col-sm-4 grid-margin">
            <a href="{{ route('store.categories.index') }}" style="text-decoration:none;">
                <div class="card shadow"
                    style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); border: none; transition: transform 0.3s ease;">
                    <div class="card-body">
        ...
        <div class="col-sm-4 grid-margin">
            <a href="{{ route('store.products.index') }}" style="text-decoration:none;">
                <div class="card shadow"
                    style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); border: none; transition: transform 0.3s ease;">
                    <div class="card-body">
        ...
        <div class="col-sm-4 grid-margin">
            <a href="{{ route('store.orders.index') }}" style="text-decoration:none;">
                <div class="card shadow"
                    style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); border: none; transition: transform 0.3s ease;">
                    <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <a href="{{ route('store.profile.index') }}"
                                class="btn btn-info w-100 d-flex align-items-center justify-content-center gap-2">
    ...
    <script>
        window.storeId = {{ Auth::guard('store')->user()->id }};
    </script>
