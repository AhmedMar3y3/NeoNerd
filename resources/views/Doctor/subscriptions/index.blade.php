...
<div class="subscriptions-container" dir="rtl">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">إدارة اشتراكات المستخدمين في دوراتك</p>
    </div>
    ...
    <div class="filters-section">
        ...
        <form method="GET" action="{{ route('doctor.subscriptions.index') }}">
            ...
            <div class="filters-actions">
                ...
                <a href="{{ route('doctor.subscriptions.index') }}" class="btn-clear">
    ...
    <div class="actions-container">
        <div class="add-subscription-section">
            <a href="{{ route('doctor.subscriptions.create') }}" class="btn-add-subscription">
    ...
    <!-- Bulk Action Form -->
    <form id="bulk-action-form" method="POST" action="{{ route('doctor.subscriptions.bulk-action') }}" style="display: none;">
    </form>
