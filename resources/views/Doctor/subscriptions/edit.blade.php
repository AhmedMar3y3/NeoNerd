...
<div class="subscription-form-container" dir="rtl">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">تعديل معلومات الاشتراك</p>
    </div>
    ...
    <div class="form-card">
        ...
        <p class="form-description">قم بتعديل المعلومات التالية</p>
        
        <form method="POST" action="{{ route('doctor.subscriptions.update', $subscription->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        ...
                        <label for="is_active" class="form-check-label">تفعيل الاشتراك</label>
                    </div>
                    <div class="form-text">اترك هذا الخيار مفعلاً لتفعيل الاشتراك</div>
                </div>
            </div>
