...
@section('main')
<div class="create-subject-container" dir="rtl">
    <!-- Page Header -->
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="page-title">إضافة مادة جديدة</h1>
                <p class="page-subtitle">إضافة مادة دراسية جديدة للنظام</p>
            </div>
    ...
    <div class="form-container">
        <h2 class="form-title">معلومات المادة</h2>
        
        <form action="{{ route('admin.subjects.store') }}" method="POST" enctype="multipart/form-data" id="subjectForm">
            @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('academic_level') is-invalid @enderror" 
                                ...
                                @foreach($filterOptions['academic_levels'] as $level)
                                    <option value="{{ $level->value }}" {{ old('academic_level') === $level->value ? 'selected' : '' }}>
                                        {{ $level->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('college_type_id') is-invalid @enderror" 
                                ...
                                @foreach($filterOptions['college_types'] as $collegeType)
                                    <option value="{{ $collegeType->id }}" {{ old('college_type_id') == $collegeType->id ? 'selected' : '' }}>
                                        {{ $collegeType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('secondary_type') is-invalid @enderror" 
                                ...
                                @foreach($filterOptions['secondary_types'] as $type)
                                    <option value="{{ $type->value }}" {{ old('secondary_type') === $type->value ? 'selected' : '' }}>
                                        {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('secondary_grade') is-invalid @enderror" 
                                ...
                                @foreach($filterOptions['secondary_grades'] as $grade)
                                    <option value="{{ $grade->value }}" {{ old('secondary_grade') === $grade->value ? 'selected' : '' }}>
                                        {{ $grade->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('secondary_section') is-invalid @enderror" 
                                ...
                                @foreach($filterOptions['secondary_sections'] as $section)
                                    <option value="{{ $section->value }}" {{ old('secondary_section') === $section->value ? 'selected' : '' }}>
                                        {{ $section->name }}
                                    </option>
                                @endforeach
                            </select>
